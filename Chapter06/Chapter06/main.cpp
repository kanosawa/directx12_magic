...
void main() {
	...
	while (true)
	{
		...
		*mapMatrix = worldMat * viewMat * projMat;
		...
		render05(dev, rtvDescriptorHeap, commandList, vertexBufferView, indexBufferView, swapChain, rootSignature, pipelineState, viewport, scissorRect, basicDescriptorHeap);
		commandList->Close();
